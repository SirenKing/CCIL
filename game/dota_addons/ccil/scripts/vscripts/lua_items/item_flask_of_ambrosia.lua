LinkLuaModifier( "ChangeTargets", "modifiers/changetargets.lua", LUA_MODIFIER_MOTION_NONE )
...
================================================================================================================= ]]
function modifier_item_flask_of_ambrosia_datadriven_aura_on_death(keys)
	...
	for i=0, 5, 1 do
		...
		if current_item ~= nil then
			...
			if item_name == "item_flask_of_ambrosia_datadriven" then
...
================================================================================================================= ]]
function modifier_item_flask_of_ambrosia_datadriven_aura_emitter_on_kill(keys)
	--We want to award a charge in the event of a long-range kill as well.  The killed unit will still have the aura modifier
	--on them if they are in range (in which case item_flask_of_ambrosia_modifier_aura_on_death() would award the killer a charge),
	--but will not have the modifier if they are out of range.
	if not keys.unit:HasModifier("modifier_item_flask_of_ambrosia_datadriven_aura") then
		item_flask_of_ambrosia_modifier_aura_on_death(keys)
	end
end
...
================================================================================================================= ]]
function modifier_item_flask_of_ambrosia_datadriven_damage_on_interval_think(keys)
...
================================================================================================================= ]]
function modifier_item_flask_of_ambrosia_datadriven_heal_on_interval_think(keys)
...
================================================================================================================= ]]
function modifier_item_flask_of_ambrosia_datadriven_heal_on_take_damage(keys)
	...
	if keys.Damage > 0 and (keys.attacker:IsTower() or keys.attacker:IsHero()) then
		keys.unit:RemoveModifierByName("modifier_item_flask_of_ambrosia_datadriven_heal")
	end
end
...
--[[ ============================================================================================================
	...
	an ally or enemy.
================================================================================================================= ]]
function item_flask_of_ambrosia_datadriven_on_spell_start(keys)
	...
	if keys.caster:GetTeam() == keys.target:GetTeam() then   --Apply the healing version of the Urn modifier.
		keys.ability:ApplyDataDrivenModifier(keys.caster, keys.target, "modifier_item_flask_of_ambrosia_datadriven_heal", nil)
	else  --Apply the damaging version of the Urn modifier.
		keys.ability:ApplyDataDrivenModifier(keys.caster, keys.target, "modifier_item_flask_of_ambrosia_datadriven_damage", nil)
  	keys.ability:ApplyDataDrivenModifier(keys.caster, keys.target, "ChangeTargets", { duration = 8 })
	end
